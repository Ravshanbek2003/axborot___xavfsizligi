  ...
  return (
    <div>
      <Container fluid className="resume-section">
        <h1>
          Xavfsizlik buzilganini aniqlovchi dasturlar, tizimlarni va dasturlarni
          imtihon qilish, xavfsizlikni tekshirish, zararli kodlarni aniqlash va
          yuzlab ommaviy tarmoqdan muhofaza qilish uchun ishlatiladi. Quyidagi
          dasturlar ushbu maqsadlarga yo'naltirilgan:
        </h1>
        ...
        <div>
          ...
          >
            <h1 style={{ color: 'gold' }}>1.Nmap:</h1>
            <p style={{ fontSize: "30px", fontWeight: "600" }}>
              Tarmoqda qanday qurilgan joylashuvlarning topilishini va
              tekshirishini osonlashtirish uchun ishlatiladi.
            </p>
          </div>
          <img
          ...
          >
            <h1 style={{ color: 'gold' }}>2.Wireshark:</h1>
            <p style={{ fontSize: "30px", fontWeight: "600" }}>
              Paketlar ro'yhatini ko'rsatib, tarmoqda yuborilgan va qabul
              qilingan ma'lumotlarni monitoring qilish.
            </p>
          </div>
          <img
          ...
          >
            <h1 style={{ color: 'gold' }}>3.Metasploit:</h1>
            <p style={{ fontSize: "30px", fontWeight: "600" }}>
              Xavfsizlik va sinalganlik imkoniyatlarini oshirish maqsadida
              testlov qilish va jiddiy xavfsizlik masalalarni aniqlash uchun
              ishlatiladi.
            </p>
          </div>
          <img
          ...
          >
            <h1 style={{ color: 'gold' }}>4.OpenVAS:</h1>
            <p style={{ fontSize: "30px", fontWeight: "600" }}>
              Ochiq manbalari va tizimlar uchun xavfsizlik skaner va islohot
              tizimi. Tizimni tekshirib, topilgan nukusliklarni tuzatish uchun
              yordam beradi.
            </p>
          </div>
          <img
          ...
          >
            <h1 style={{ color: 'gold' }}>5.Snort:</h1>
            <p style={{ fontSize: "30px", fontWeight: "600" }}>
              Paketlarni monitoring qilish va nazorat qilish uchun tuzilgan
              sinov dasturi.
            </p>
          </div>
          <img
          ...
          >
            <h1 style={{ color: 'gold' }}>6.ClamAV:</h1>
            <p style={{ fontSize: "30px", fontWeight: "600" }}>
              Viruslar va zararli fayllarni aniqlash va o'chirish uchun
              xavfsizlik skaneri.
            </p>
          </div>
          <img
          ...
          >
            <h1 style={{ color: 'gold' }}>7.John the Ripper:</h1>
            <p style={{ fontSize: "30px", fontWeight: "600" }}>
          ...
          >
            <h1 style={{ color: 'gold' }}>8.Wi-Fi Analyzer:</h1>
            <p style={{ fontSize: "30px", fontWeight: "600" }}>
          ...
          >
            ...
            <p style={{ fontSize: "30px", fontWeight: "600" }}>
              Tizimdagi o'zgarishlarni tekshirib, xavfsizlikni monitoring qilish
              va nazorat qilish uchun ishlatiladi.
            </p>
          </div>
          <img
          ...
          >
            <h1 style={{ color: 'gold' }}>10.Yara:</h1>
            <p style={{ fontSize: "30px", fontWeight: "600" }}>
              Malumotlar bazasidan bor zararli fayllarni aniqlovchi, izlaydigan
              va aniqlagan ishlab chiqilgan dastur.
            </p>
          </div>
          <img
          ...
          >
            <h1 style={{ color: 'gold' }}>11.OSSEC:</h1>
            <p style={{ fontSize: "30px", fontWeight: "600" }}>
